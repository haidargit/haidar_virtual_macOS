import { FaJenkins, FaVuejs } from "react-icons/fa";
import {
  GiNinjaHeroicStance,
  GiJumpingDog,
  GiEnergySword,
    ...
    md: [
      {
        ...
        excerpt: "Hey there! Name's Haidar. nice to know you a..."
      },
      {
        id: "github-stats",
        title: "Github Stats",
        ...
        icon: <VscGithub />,
        excerpt: "haidargit's stats (powered by..."
      },
      {
        id: "about-site",
        title: "About haidar-aesthetic",
        file: "markdown/about-site.md",
        icon: <GoBrowser />,
        excerpt: "www.haidar-aesthetic.com is one of my experi..."
      }
    ]
  },
  // {
